...
```powershell
# Create a local global.json
# Open file and set preferd sdk
dotnet new global.json
dotnet new globaljson --sdk-version 9.0.305 --roll-forward latestFeature
...
# Search packages
dotnet package search Benchmark --format json
```
